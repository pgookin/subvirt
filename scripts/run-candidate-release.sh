...
if [[ "$BUILD_SCOPE" == "provider" ]]; then
  UBUNTU_TARGETS=${UBUNTU_TARGETS:-${SUBVIRT_UBUNTU_TARGETS:-all}}
  ALMA_TARGETS=${ALMA_TARGETS:-${SUBVIRT_ALMA_TARGETS:-all}}
  LAB_TARGETS=${LAB_TARGETS:-${SUBVIRT_LAB_TARGETS:-all}}
else
  ...
  LAB_TARGETS=${LAB_TARGETS:-${SUBVIRT_LAB_TARGETS:-selected}}
fi
export SUBVIRT_UBUNTU_TARGETS="$UBUNTU_TARGETS"
export SUBVIRT_ALMA_TARGETS="$ALMA_TARGETS"
export SUBVIRT_LAB_TARGETS="$LAB_TARGETS"
...
summary "- Lab targets: \`$LAB_TARGETS\`"
