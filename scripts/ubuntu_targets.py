...
DEFAULT_TARGETS = [
    UbuntuTarget(
        ...
        patch="truenas-storage-backend-u18.patch",
    ...
    UbuntuTarget(
        ...
        patch="truenas-storage-backend-u20.patch",
    ...
    UbuntuTarget(
        ...
        patch="truenas-storage-backend-u22.patch",
    ...
    UbuntuTarget(
        ...
        patch="truenas-storage-backend-u26.patch",
